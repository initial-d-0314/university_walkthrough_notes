...
<x-app-layout>
    ...
    <div class="p-6 text-gray-900">
        <form action="{{route('university_store')}}" method="post">
            ...
            <input type="text" class="text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md" name="university[name]" placeholder="大学名" value="{{ old('university.name') }}" /><br>
            ...
            <input type="text" class="text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md" name="university[section]" placeholder="分類" value="{{ old('university.section') }}" /><br>
            ...
            <input type="text" class="text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md" name="university[address]" placeholder="大学名"value="{{ old('university.address') }}" /><br>
            ...
            <p>大学の公式サイトのURLです。</p>
            <input type="text" class="text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md" name="university[url]" placeholder="公式サイトのURL"value="{{ old('university.url') }}" /><br>
            ...
            <input type="text" class="text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md" name="university[nearest_station]" placeholder="大学名" value="{{ old('university.nearest_station') }}" /><br>
            ...
            <div class="">
            <input type="submit" class="inline-flex items-center px-4 py-2 bg-blue-700 border border-transparent rounded-md   text-white tracking-widest hover:bg-blue-600 focus:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out" value="大学データ変更"/>
