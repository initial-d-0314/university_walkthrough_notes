...
<x-app-layout>
    ...
    <div class="py-12">
        ...
        <form action="{{ route('university_update',['university' => $university->id])}}" method="post">
            ...
            @endif
        <div class="">
            <input type="submit" class="inline-flex items-center px-4 py-2 bg-blue-700 border border-transparent rounded-md  text-xs text-white hover:bg-blue-600 focus:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out" value="大学データ変更"/>
